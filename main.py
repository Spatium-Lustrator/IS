...
adresses_markup.add(but5, but6, but7)
    ...
    if message.text == 'Корзина':
        ...
        if db.basket['empty'] == False:
            ...
            if couel == 1:
                ...
                qb.send_message(message.from_user.id, 'Итого: %s' % all_data['now_price'], reply_markup=delete_markup1)

            elif couel == 3:
                qb.send_message(message.from_user.id, 'Итого: %s' % all_data['now_price'], reply_markup=delete_markup2)
